...
def load_coordinate_rmsf_onehot(directory_path, selection='name CA and not (name H*)'):
    '''
...
if __name__ == '__main__':
    ...
    rmsf_values, one_hot_trajs = load_coordinate_rmsf_onehot(directory_path)
